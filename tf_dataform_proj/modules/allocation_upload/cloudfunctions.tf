# TODO: Keep zipping in a loop

data "archive_file" "ratios_to_bq_zip" {
  type        = "zip"
  output_path = "cloud_functions/allocation_ratios.zip"
  source_dir  = "../cloud_functions/allocation_ratios"
  provider    = archive
}

# data "archive_file" "snps_a005" {
#   type        = "zip"
#   output_path = "cloud_functions/snps_a005.zip"
#   source_dir  = "../../../cloud_functions/snps_a005"
#   provider    = archive
# }
